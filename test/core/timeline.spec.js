...
describe('Timeline tests', () => {
    ...
    describe('Constructor behavior', () => {
        ...
        it('Constructs correctly', () => {
            ...
            expect(timeline._node_tracks.length).to.be.equal(0);
        });
    });
    ...
    describe('Keyframe adding behavior', () => {
        ...
        it('Adds single keyframe correctly', () => {
            ...
            expect(timeline._node_tracks.length).to.be.equal(1);
            expect(timeline._node_tracks[0].translateX.length).to.be.equal(21);
            expect(timeline._node_tracks[0].translateX[0].value).to.be.equal(0);
            expect(timeline._node_tracks[0].translateX[20].value).to.be.equal(21);
        });
        ...
        it('Adds multiple keyframes in mixed order correctly', () => {
            ...
            expect(timeline._node_tracks.length).to.be.equal(1);
            expect(timeline._node_tracks[0].translateX.length).to.be.equal(5001);
            expect(timeline._node_tracks[0].translateX[0].value).to.be.equal(0);
            expect(timeline._node_tracks[0].translateX[20].value).to.be.equal(21);
            expect(timeline._node_tracks[0].translateX[5000].value).to.be.equal(5001);
            expect(timeline._node_tracks[0].translateX[300].value).to.be.equal(301);
            let result = '';
            for (var property in timeline._node_tracks[0].translateX) {
                if (timeline._node_tracks[0].translateX.hasOwnProperty(property)) {
                    result += timeline._node_tracks[0].translateX[property].value;
                }
            }
    ...
    describe('Keyframe removing behavior', () => {
        ...
        it('Removes single keyframe correctly', () => {
            ...
            expect(timeline._node_tracks.length).to.be.equal(1);
            expect(timeline._node_tracks[0].translateX).not.to.exist;
        });
        ...
        it('Removes multiple keyframes in mixed order correctly', () => {
            ...
            expect(timeline._node_tracks[0].translateX.length).to.be.equal(5001);
            expect(timeline._node_tracks[0].translateX[0].value).to.be.equal(0);
            expect(timeline._node_tracks[0].translateX[20]).not.to.exist;
            expect(timeline._node_tracks[0].translateX[300].value).to.be.equal(301);
            expect(timeline._node_tracks[0].translateX[5000]).not.to.exist;
        ...
        it('Removes multiple keyframes from multiple tracks in mixed order correctly', () => {
            ...
            expect(timeline._node_tracks.length).to.be.equal(1);
            expect(timeline._node_tracks[0].translateX).not.to.exist;
            expect(timeline._node_tracks[0].translateY[0].value).to.be.equal(0);
            expect(timeline._node_tracks[0].translateY[300].value).to.be.equal(301);
            expect(timeline.remove(node, keyframe_c, keyframe_a)).to.be.equal(timeline);
            expect(timeline._node_tracks[0].translateY).not.to.exist;
        });
    });
    ...
    describe('Seeking to the given time', () => {
        ...
        it('Seeks single node to the keyframed time correctly', () => {
            ...
            expect(timeline.add(node, keyframe)).to.be.equal(timeline);
            expect(timeline._node_tracks[0].translateX[20].value).to.be.equal(140);
