...
export function get_quadratic_function_for(start, control, end, t) {
    const a = 1 - t;
...
export function get_cubic_function_for(start, control_a, control_b, end, t) {
    const t2 = t * t;
    const a = 1 - t;
    const a2 = a * a;
    return start * a2 * a + control_a * 3 * a2 * t + control_b * 3 * a * t2 + end * t2 * t;
}

/**
 * Get extremas for a cubic bezier function, by calculation roots of its
 * derivatives
 */
